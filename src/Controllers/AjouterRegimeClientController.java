 ...
 * @author ASUS
 */
public class AjouterRegimeClientController implements Initializable {
    ...
    try {
           ...
           Logger.getLogger(AjouterRegimeClientController.class.getName()).log(Level.SEVERE, null, ex);
       }
    }}
    ...
    private void redirListerAliment(ActionEvent event) {
        ...
        alert.setTitle("oui biensur ");
         ...
         try {
            ...
            Stage stage = new Stage();
            stage.setScene(new Scene(root));
            stage.setTitle("Lister Aliment Client");
            stage.show(); 
        } catch (IOException ex) {

 ...
 * @author ASUS
 */
public class HomeAlimentationClientController implements Initializable {
    ...
    private void ListerAliment(ActionEvent event) {
        try {
            ...
            Logger.getLogger(HomeAlimentationClientController.class.getName()).log(Level.SEVERE, null, ex);
        }

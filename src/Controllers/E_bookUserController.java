 ...
 * @author Kenza
 */
public class E_bookUserController implements Initializable {
...
//        {
           ...
           if (SystemTray.isSupported()) {
            ...
            try {
                ...
                Logger.getLogger(E_bookUserController.class.getName()).log(Level.SEVERE, null, ex);
            }
...
//                    tfauteur.getScene().setRoot(root);
    ...
    private void refresh(ActionEvent event) {
        try {
            ...
            Parent root = loader.load();
            E_bookUserController e = loader.getController();
            //   e.setYarab(id);

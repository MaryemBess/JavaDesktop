 ...
 * @author ASUS
 */
public class ListerAlimentController implements Initializable {
 ...
 public int id;
    ...
    private void AjouterAliment(ActionEvent event) {
         try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/guiAliment/AjouterAliment.fxml"));
            Parent root =loader.load();
            AjouterAlimentController pdc = loader.getController();
    ...
    private void Details(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/guiAliment/DetailAliment.fxml"));
            Parent root =loader.load();
            DetailAlimentController pdc = loader.getController();

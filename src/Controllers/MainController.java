    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     private void makeStageDrageable() {
        ...
        border_pane.setOnMouseDragged(new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent event) {
                Meliora.stage.setX(event.getScreenX() - xOffset);
                Meliora.stage.setY(event.getScreenY() - yOffset);
                Meliora.stage.setOpacity(0.7f);
            }
        });
        border_pane.setOnDragDone((e) -> {
            Meliora.stage.setOpacity(1.0f);
        });

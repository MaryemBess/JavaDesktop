...
loadUI("/gui/E_bookAdmin.fxml");
 ...
 loadUI("/gui/PageAdmin.fxml");
    }
    private void Statique(ActionEvent event) {
            loadUI("/gui/stat.fxml");
